...
(defun switch-to-fetchmail ()
  ...
  (let ((fetchmail-buf
         (get-buffer-or-call-func
          ...
          (function
           (lambda ()
             (start-fetchmail "*fetchmail*" nil
                              "-f" "/Users/benn/Mine/.Data/PrivateData/.fetchmailrc")))))
        ;; (fetchmail-lists-buf
        ;;  (get-buffer-or-call-func
        ;;   "*fetchmail-lists*"
        ;;   (function
        ...
        ;;        (setenv "FETCHMAILHOME" (expand-file-name "~/Mine/Documents/Messages/Newsdir"))
        ;;        (start-fetchmail "*fetchmail-lists*" nil
        ;;                         "-f" (expand-file-name
        ;;                               "~/Mine/Documents/Messages/.fetchmailrc")))))))
        ;; (fetchmail-spam-buf
        ;;  (get-buffer-or-call-func
        ;;   "*fetchmail-spam*"
        ;;   (function
        ...
        ;;                     "-d" (expand-file-name "~/Mine/Documents/Messages/Newsdir")
        ;;                     "-F" (expand-file-name "~/Mine/Documents/Messages/leafnode/config")
        ;;                     "-vvv" "-n")))))
...
(defun fetchnews-post ()
  ...
  (async-shell-command
   (format "fetchnews -F %s -vv -n -P"
           (expand-file-name "~/Mine/Documents/Messages/leafnode/config"))))
