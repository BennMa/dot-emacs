...
(defun my-emacs-theme ()
  ...
  (color-theme-install
   '(my-emacs-theme
     ...
     (org-level-1 ((t (:bold t :foreground "dodger blue" :height 1.2 :box))))
     (org-level-2 ((t (:bold nil :foreground "#edd400" :height 1.1 :box))))
     (org-level-3 ((t (:bold t :foreground "#6ac214" :box))))
     (org-level-4 ((t (:bold nil :foreground "tomato"))))
     (org-document-title ((t (:inherit org-level-1 :height 1.3 :underline nil))))
     ...
     (org-habit-ready-future-face ((((background light)) (:background
                                                          "#acfca9"))))
     (org-agenda-structure ((t (:inherit default :height 1.3 :underline nil :foreground "tomato"))))
     (org-agenda-date ((t (:foreground "#6ac214" :height 1.6))))
     (org-agenda-date-weekend ((t (:foreground "dodger blue" :height 1.6))))
     (org-agenda-date-today ((t (:foreground "#edd400" :height 1.6))))
