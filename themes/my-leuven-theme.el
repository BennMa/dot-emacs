...
(let ((class '((class color) (min-colors 89)))
      ...
      ;; "#EFFFEF"))
      (ol1 '(:height 1.3 :weight bold :foreground "#3C3C3C"))
      (ol2 '(:height 1.0 :weight bold :foreground "#123555"))
  ...
  (custom-theme-set-faces
   'my-leuven
   `(default ((,class (:foreground "#333333" :background "LightBlue"))))
   ...
   `(cursor ((,class (:background "black")))) ;; #21BDFF
   ...
   `(org-default ((,class (:foreground "#333333" :background "LightBlue"))))
   ...
   `(org-done ((,class (:weight bold :foreground "#BBBBBB")))) ;; :box (:line-width 1 :color "#BBBBBB")  :background "#F0F0F0"
   ...
   `(org-headline-done ((,class (:strike-through t)))) ;; :height 1.0 :weight normal  :foreground "#ADADAD"
   ...
   `(org-todo ((,class (:weight bold :foreground "#D8ABA7")))) ;; :box (:line-width 1 :color "#D8ABA7")  :background "#FFE6E4"
